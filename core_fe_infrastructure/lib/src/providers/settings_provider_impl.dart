...
class SettingsProviderImpl implements SettingsProvider {
  ...
  @override
  Future<void> deleteSettings() => _noSqlStorageManager.delete(StorageKey.settingsStorageKey);

  @override
  Future<Settings?> getSettings() =>
      _noSqlStorageManager.get<Settings>(StorageKey.settingsStorageKey, fromJsonFunc: (map) => Settings.fromMap(map));

  @override
  Future<void> initSettings(Settings settings) => _noSqlStorageManager.addOrUpdate<Settings>(
  ...
  @override
  Future<void> updateSettings(Settings settings) => _noSqlStorageManager.addOrUpdate<Settings>(
        key: StorageKey.settingsStorageKey,
        data: settings,
        toJsonFunc: (s) => s?.toMap(),
      );
