...
typedef DurationFormatterFunc = String Function(Duration duration, Language language);
typedef ToDateTimeFunc = DateTime? Function(String string);
typedef DateFormatterFunc = String Function(DateTime dateTime, Language language);
